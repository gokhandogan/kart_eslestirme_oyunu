...
public class PictureManager : MonoBehaviour
{
    ...
    private Vector2 _offsetFor20Pairs = new Vector2(1.4f, 1.0f);
    ...
    void Start()
    {
        ...
        _removedPairs = 0;
        _pairNumbers = (int) GameSettings.Instance.GetEPairNumber();
    ...
    private void SpawnPictureMesh(int rows, int coloumns, Vector2 Pos, Vector2 offset, bool scaledown)
    {
    ...
    private void MovePicture(int rows, int coloumns, Vector2 pos, Vector2 offset)
    {
